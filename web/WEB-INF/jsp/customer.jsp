        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <form class="form-inline" action="${pageContext.request.contextPath }/customer/list.action"
                    ...
                    <div class="form-group">
                        <label for="customerState">客户状态</label>
                        <select class="form-control" id="customerState" placeholder="客户来源" name="custState">
                            <option value="">--请选择--</option>
                            <c:forEach items="${customerStates}" var="item">
                                <option value="${item.dict_id}"<c:if
                                        test="${item.dict_id == custState}"> selected</c:if>>${item.dict_item_name }</option>
                            </c:forEach>
                        </select>
                    </div>
                    <div class="form-group">
